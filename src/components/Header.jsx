  ...
  return (
    <>
      ...
      >
        ...
        <img src={heart} alt="heart" className=" ml-5 z-0 w-[40px] lg:w-[60px] inline" />
        ...
        <div className="flex">
          ...
          <button className=" rounded-full bg-gradient-to-br from-[#ff6600] to-pink-400 text-white font-bold px-1 py-1 m-5">
